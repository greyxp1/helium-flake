...
for id in "$@"; do
    ...
    url="https://clients2.google.com/service/update2/crx?response=redirect&os=linux&arch=x64&os_arch=x86_64&nacl_arch=x86-64&prod=chromiumcrx&prodchannel=stable&prodversion=148.0.0.0&acceptformat=crx3&x=id%3D${id}%26installsource%3Dondemand%26uc"
